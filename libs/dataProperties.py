...
class NumericData():
    # number of continuous calculation errors to avoid create infinity number of directories without profit of calculation:
    global_number_of_continuous_calc_errors = 0
    global_R_factor = -1
