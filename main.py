...
# load the main Class:
from libs.load_and_compare_data import WorkWithXPSSpectra
...
if __name__ == "__main__":
    ...
    #
    # Compare 10 different cases for SixNb1-x of concentration
    #
